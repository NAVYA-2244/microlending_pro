...
//   // const getTimeDifference = (dateStr) => Math.abs(new Date(dateStr) - currentDate);

//   // Find the object with the nearest date
//   // const nearestDateObject = loanList.reduce((nearest, obj) => {
//   //   const timeDiff = getTimeDifference(obj.date_of_application);
//   //   if (timeDiff < nearest.timeDifference) {
//   //     return { object: obj, timeDifference: timeDiff };
//   //   }
//   //   return nearest;
//   // }, { object: null, timeDifference: Infinity }).object;

//   // // Print the object with the nearest date
//   // console.log(nearestDateObject, "hello");
...
//     const nextEMIDate = new Date(loan?.emi_detals?.nextEMIDate);
...
//       return nearest;
//     }
//   }, new Date(loanList[0]?.emi_detals?.nextEMIDate));
...
//                             <span>
//                               {loan.emi_detals.nextEMIDate === "0" ? " " : "Date"}
//                               <span className="text-white fw-semibold">{loan.emi_detals.nextEMIDate === "0" ? " " : loan.emi_detals.nextEMIDate}</span>
//                             </span>
//                           ))}
